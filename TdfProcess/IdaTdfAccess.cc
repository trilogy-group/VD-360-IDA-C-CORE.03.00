...
#ifdef _WINDOWS
  PcpComInitializer initCOMIfUninitialized;
#endif

 idaTrackTrace(("TdfAccess::handleRequest after pcpcominitializer"));
                                                ...
                                                String& errorText)
{
  ...
  ClNode * childNode;
  childNode = PCPXML:: getFirstChild ( rootNode );
  ...
  while ( childNode )
  {
    ...
    childNode = PCPXML:: getNextSibling ( childNode );
       ...
       if ( grandchildNodeName == "Attribute")
       {
         if (getValueOfDomNode(stringValue, grandchildNode) == isOk)
         {
           if (StringToEnum::enumOfAttributeId(enumVal, stringValue.cString()) == isOk)
           {
             ...
             legalAttribut = true;
             grandchildNode = PCPXML:: getNextSibling ( grandchildNode );
             continue;
           }
         }
...
ReturnStatus TdfAccess::getValueOfDomNode ( String& textValue, ClNode* node )
{
	...
	const ClNode * textNode = PCPXML:: getFirstChild( node );
      ...
      while ( flagNode )
      {
        ...
        if ( flagNodeName == "Flag" )
        {
          ...
          while ( flagNodeChild )
          {
            ...
            flagNodeChild = PCPXML:: getNextSibling ( flagNodeChild );
        ...
        flagNode = PCPXML:: getNextSibling ( flagNode );
      } // end while (flagNode)
